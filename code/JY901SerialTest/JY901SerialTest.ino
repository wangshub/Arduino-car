...
{
  mySerialEvent() ;
  //print received data. Data was received in mySerialEvent;
...
/*
  mySerialEvent occurs whenever a new data comes in the
 hardware mySerial RX.  This routine is run between each
